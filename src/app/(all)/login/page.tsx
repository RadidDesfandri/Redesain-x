...
export default function Login() {
  ...
  return (
    <section className='min-h-screen  flex justify-center items-center bg-black/60'>
      <div className=' bg-black rounded-xl mx-auto lg:w-[400px] w-[400px] h-[600px] overflow-auto flex flex-col'>
        ...
        <div className='justify-center'>
          <h1 className='text-white font-semibold text-2xl flex lg:ml-5 ml-5 pt-7 px-6 items-start'>Sign in to X</h1>
