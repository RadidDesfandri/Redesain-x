                    ...
                    <div className='flex flex-col items-center md:items-start'>
                        ...
                        <div className='flex flex-col gap-2 '>
                            <div className='flex items-center justify-center gap-6 bg-white w-[320px] md:w-[360px] h-11 rounded-full'>
                                ...
                                <span className='text-gray-500'>Register with Google</span>
                            </div>
                            <div className='flex items-center justify-center gap-6 bg-white w-[320px] md:w-[360px] h-11 rounded-full'>
                                ...
                                <span className='text-gray-500'>Register with Apple</span>
                            </div>
                        </div>
                        <div className='flex items-center gap-2 py-2'>
                            <span className='w-[140px] h-[1px] bg-gray-500'></span><p>or</p><span className='w-[140px] h-[1px] bg-gray-500'></span>
                        </div>
                        <button type='submit' className='flex items-center justify-center gap-6 bg-[#1D9BF0] w-[320px] md:w-[360px] h-11 rounded-full font-semibold '>Create account</button>
                        ...
                        <div className='pb-8'>
                            ...
                            <button className='w-[320px] border border-[#1D9BF0] h-11 rounded-full md:w-[360px]'>Sign in</button>
                        </div>
                    </div>
                </div>
            </div>
